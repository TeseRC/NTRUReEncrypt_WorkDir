...
/**
 *
 * @author David Nunez <dnunez (at) lcc.uma.es>
 */
...
//        }
    ...
    public IntegerPolynomial encrypt(EncryptionPublicKey pub, IntegerPolynomial m) throws Exception {
    	...
    	//System.out.println("mTrinCoefs = " + Arrays.toString(m.coeffs) + " = " + Arrays.toString(m.coeffs).length());
    ...
    public IntegerPolynomial msg2trin(byte[] msg) {
       
    	IntegerPolynomial mTrin = IntegerPolynomial.fromBinary3Sves(msg, params.N, false);
    	
        return mTrin;
    }
    
    public byte[] trin2msg(IntegerPolynomial cMTrin) {
        
    	byte[] cM = cMTrin.toBinary3Sves(false);
